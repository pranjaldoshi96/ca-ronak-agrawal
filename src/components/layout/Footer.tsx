          ...
          <div className="bg-gradient-to-r from-primary-900 to-primary-800 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#25D366] text-white rounded-lg font-medium hover:bg-[#1fb855] transition-colors"
              >
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-primary-700 rounded-lg font-medium hover:bg-slate-100 transition-colors"
              >
                Get Free Quote
              </Link>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-primary-700 font-bold text-lg">
                RA
              </div>
              <div>
                <span className="text-2xl font-bold">{COMPANY_INFO.name}</span>
                <p className="text-xs text-primary-300">Chartered Accountants</p>
              </div>
            </div>
